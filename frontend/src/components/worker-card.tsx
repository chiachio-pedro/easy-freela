...
export default function WorkerCard(props: {portrait:any, description:string, name:string}){
    return (
        <div className={styles.workerCard_container}>
            <div className={styles.worker_portrait}>
                <Image className={styles.worker_portrait_img} src={props.portrait} alt='Easy Freela logotipo'/>
            </div>
